...
* The **Coroutines-based** implementation uses `SuspendingInteractor` for single-value responses and `FlowInteractor` for cold streams.
* The **RxJava-based** implementation uses `SingleInteractor` and `CompletableInteractor` for single-value responses and `ObservableInteractor` for cold streams.

|                                     | Single-value Response                       | Cold Stream            |
|-------------------------------------|---------------------------------------------|------------------------|
